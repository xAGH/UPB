    ...
    if len(matriz) == 0:
        ...
        try:
            ...
            if ubicacion  < 1 or ubicacion > 3:
                ...
                print(f"La zona wifi 1: ubicada en ['{distancias[0][1][0]}', '{distancias[0][1][1]}'] a {distancias[0][0]} metros, tiene en promedio {distancias[0][1][2]} usuarios.")
                print(f"La zona wifi 2: ubicada en ['{distancias[1][1][0]}', '{distancias[1][1][1]}'] a {distancias[1][0]} metros, tiene en promedio {distancias[1][1][2]} usuarios.")
...
def indicaciones_llegada(indicaciones, distancias, ubicacion_actual):
    ...
    tiempo_bus = round((distancia_zona_wifi / tiempo_promedio_bus) / 60, 2)
    tiempo_bici = round((distancia_zona_wifi / tiempo_promedio_bicicleta) / 60, 2)
    tiempo_calculado = f"Se demorará aproximadamente {tiempo_bus}min si va en bus o {tiempo_bici}min si va en bicicleta."
    sys("cls")
    print(f"{ruta}\n{tiempo_calculado}")
